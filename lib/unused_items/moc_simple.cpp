...
**
** Created: Tue May 13 13:55:19 2014
...
static const char qt_meta_stringdata_Simple[] = {
    "Simple\0\0onComboBoxChanged(int)\0"
...
void Simple::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Simple *_t = static_cast<Simple *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData Simple::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Simple::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Simple,
      qt_meta_data_Simple, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Simple::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Simple))
        return static_cast<void*>(const_cast< Simple*>(this));
